          ...
          <div className="pt-6">
            <h1 className="pb-6 text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
              ...
              <span className="text-pink-500 dark:text-emerald-400">
                <Typewriter
                  words={['Diana', 'a Thinker', 'a Mentor', 'a Speaker', 'a Builder']}
                  colors={[
                    'text-pink-500',
                    'text-amber-500',
                    'text-sky-500',
            ...
            <div className="mt-8 grid grid-cols-1 grid-rows-3 gap-8">
              ...
              <div className="my-2 grid items-start gap-8">
                <div className="group relative">
                  ...
                  <Link href="https://docs.google.com/document/d/1knogje1z4SYWU-kDH8iQGJBrwSFp7zqSDYqaZdq7JBI/edit?usp=sharing">
                    <span className="relative flex w-80 items-center justify-between divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      {' '}
                      <span className="flex w-64 items-center space-x-5">
                        <svg
                      ...
                      <span className="pl-6 text-emerald-400 transition duration-200 group-hover:text-gray-900 dark:group-hover:text-gray-100">
                        Resume&nbsp;&rarr;
                      </span>
                    </span>
                  </Link>
